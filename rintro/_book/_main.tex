...
\urlstyle{same}
\hypersetup{
  pdftitle={R Workshops for School of Psychology},
  pdfauthor={Ryan Donovan (ryan.donovan@universityofgalway.ie)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{R Workshops for School of Psychology}
\author{Ryan Donovan (\href{mailto:ryan.donovan@universityofgalway.ie}{\nolinkurl{ryan.donovan@universityofgalway.ie}})}
\date{Last update: 2024-01-16}
...
\hypertarget{introduction-what-is-r}{%
\chapter{Introduction: What is R?}\label{introduction-what-is-r}}

This e-book describes how to use R to import, clean, and process psychological data. All materials, data, and information in this e-book are used for educational purposes only. This document should only be shared within the University of Galway's School of Psychology, and is not intended for widespread dissemination. The e-book is very much in its draft stages and will be updated and fine-tuned in the future. Several materials are adapted from several online resources on teaching R. These materials are as follows: (ref: xie2015).
...
There are both extrinsically motivated and intrinsically motivated reasons to learn R. Let's focus on the extrinsically motivated reasons first:
...
It will make you more competitive in the field. A survey of LinkedIn career opportunities in the field of data science and entry, 80\% require that you have skills in either R or Python when it comes to statistical programming. If one day you feel like you need an excursion from academia, R can potentially open doors for you in industry.
...
\hypertarget{cross}{%
\chapter{Getting Started with R and RStudio}\label{cross}}
...
\href{https://bbc.github.io/rcookbook/\#:~:text=At\%20the\%20BBC\%20data\%20team,to\%20R\%20to\%20create\%20graphics.}{\includegraphics{figures/01-bbc.png}}
...
\item
  Under the heading \emph{Download and Install R,} click \emph{Download R for Windows} \includegraphics[width=29.20833in,height=\textheight]{figures/01-cran.png}
\item
  Click the hyperlink \textbf{\emph{base}} or \textbf{\emph{install R for the first Time}}\includegraphics{figures/01-base.png}
\item
  Click Download R-4.3.2 for Windows (depending on the date you accessed this, the version of R might have been been updated. That's okay, you can download newer versions). Let the file download. \includegraphics{figures/01-download.png}
\item
...
\item
  The website should automatically detect your operating system. Click the \textbf{\emph{Download RStudio Desktop}} button. \includegraphics[width=7.1875in,height=\textheight]{figures/01-rstudiodownload.png}
\end{enumerate}
...
\includegraphics{figures/rstudio_first.png}
...
\includegraphics{figures/01-newproject.png}
...
\includegraphics{figures/rstudio_create_file.png}
...
\includegraphics{figures/01-four-panes.png}
...
\begin{verbatim}
## [1] "C:/Users/0131045s/Desktop/Programming/R/Workshops/Rintro_2024/rsot_v1"
\end{verbatim}
...
\includegraphics{_book/figures/01-wd.png}
...
\includegraphics{_book/figures/01-new_wd.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{View}\NormalTok{(sleep) }\CommentTok{\#this will open the dataset in your Source pane}
